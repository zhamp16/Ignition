...
#print 'opc items:'
#for item in items:
#	newNodeId = nodeId+"/"+str(item.getDisplayName())
#	nextItems = system.opc.browseServer(server, newNodeId)
#	for newItem in nextItems:
#		nextLevelId = newNodeId + '/'+ newItem.getDisplayName()
#		finalItems = system.opc.browseServer(server, nextLevelId)
...
def main():
    ...
    DRY_RUN = False  # Change to False to actually create tags
